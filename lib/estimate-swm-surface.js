...
const estimateSwmSurface = function(body, df){
   ...
   // calculate Q in m3
    ...
    if (body.infiltration !== undefined){
        ...
        body.infiltration = body.infiltration / 1000
    } else {
        if (body.infiltrationSoils !== undefined){
            ...
            body.infiltration = gl.infiltrationSoils[body.infiltrationSoils].ks
        } else {
            body.infiltration = 0
        }
    }
    ...
    if (body.infiltration === 0 && body.drainagePipeDiameter === undefined){
