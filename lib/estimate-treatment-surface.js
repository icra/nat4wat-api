...
const estimateTreatmentSurface = function(body, techs){
    // console.log("estimating treatment surface...")
    ...
    for (let i = 0; i < techs.length; i++) {
        if (body.pollutantsConcetrations !== undefined) {
            var regressionSurface = predictSurfaces(techs[i], body)
        }
