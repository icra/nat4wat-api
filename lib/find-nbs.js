...
const findNBS = function (body){
    ...
    if (body.pollutantsConcentrations !== undefined){
        body.pollutantsConcetrations = validatePollutants(body.pollutantsConcetrations)
        if (body.pollutantsConcetrations.error) return body.pollutantsConcetrations
    }
    ...
    if (df.module[0] === "swm" && isPositive(body.volume)) {
