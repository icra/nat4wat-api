...
const addSciStudy = async function(body){
    ...
    // yearOperation
    if (!isPositive(body.yearOperation) ||
        body.yearOperation < 1950 ||
        body.yearOperation > new Date().getFullYear())
        return {error: "body.yearOperation must be between 1950 and current year"}
    body.yearOperation = Number(body.yearOperation)
