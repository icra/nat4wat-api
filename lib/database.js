...
let readCases = function(params)
{
    return new Promise((resolve, reject) => {
        ...
        let query = `
            SELECT market_cases.id as id, market_cases.technology as tech, market_cases.year_construction as year_construction, market_cases.surface as surface, market_cases.construction_cost as construction_cost, market_cases.location as location,
...
let insertMarketCase = function(body)
{
    try
    {
        let queryString = `
            ...
            (id_tech, technology, year_construction,surface,construction_cost,location,website,operational_cost,capacity,description,name,id_user,validation_status)
            VALUES (${'?, '.repeat(11) + '?'},'editing')
        `;
        let values = [
            body.id_tech, body.tech, body.year_construction, body.surface, body.construction_cost, body.location,
            body.website, body.operational_cost, body.capacity, body.description, body.name, body.id_user
        ];
