...
let insertMarketCase = function(body)
{
    try
    {
        let queryString = `
            ...
            (id_tech, technology, year_construction,surface,construction_cost,location,website,construction_cost,capacity,description,name,id_user,img,validation_status)
        ...
        if(body.id)
        {
            ...
            WHERE id = ?`;
            values = [
                body.year_construction, body.surface, body.construction_cost, body.location, body.website, body.construction_cost, body.capacity, body.description, body.name, body.img, body.id
            ];
        }
