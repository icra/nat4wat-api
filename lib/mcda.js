...
const mcda = function(body){
    ...
    if (!(df.map(e => e.module).every( (val, i, arr) => val === arr[0]))) return {error: "comparing technologies for water treatment and for storm water management can produce unreliable outputs"}
