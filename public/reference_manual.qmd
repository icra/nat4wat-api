...
url_api <- "https://nat4wat-api.icradev.cat/"
```
...
The available technologies can be consulted in the tool or can be downloaded as [csv](http://nat4wat-api.icradev.cat/technologies.csv) or [json](https://nat4wat-api.icradev.cat/technologies/technologies).
