...
**TODO: Add a scheme of a technology**
...
$$
IF ~ K_tt > H, ~ THEN ~ t'_0 = \frac{H}{K_t} ~ AND ~ t'_1 = t - t'_0
$$
...
- _K~t~_ = infiltration rate of the technology layers (m/hour). When the technology stores water in a superficial layer, this is assumed as 10 m/s.
- _K~s~_ = infiltration rate of the receiving environment (m/s).
- _t_ = duration of the rain event (in s)
- $\phi$ = storage capacity of the technology (m^3^/m^3^)
- _H_ = height of the technology (in m), if the technology has a drainage system (outlet), then the height is not a limiting a factor and, therefore, is considered as infinite.
- _Q~d~_ = The flow of the drainage pipe (in m^3^/s).
...
- _r~cum(t)~_ = Cummulated rain at time _t_ (in mm).
